...
public record ActCreateDto([Required] ActType Tipo, [Required] string Titolo, [Required] string Oggetto, string? ContextNotes, Guid? ParentActId, string? BodyMd);
public record ActUpdateDto(string Titolo, string Oggetto, string? ContextNotes, string BodyMd, ActStatus Status);
...
public record ActDetailDto(Guid Id, ActType Tipo, string Titolo, string Oggetto, string? ContextNotes, string BodyMd, ActStatus Status, Guid? ParentActId, DateTime CreatedAt, DateTime UpdatedAt, List<ActRevisionDto> Revisions, List<LegalReferenceDto> LegalReferences);
