        ...
        {providers && (providers.google || providers.microsoft) && (
          <div className="mt-6">
            ...
            <div className="space-y-2">
              {providers.google && (
                <a className="btn-secondary w-full" href={`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/auth/external/google`}>
                  Accedi con Google
                </a>
              )}
              {providers.microsoft && (
                <a className="btn-secondary w-full" href={`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/auth/external/microsoft`}>
